                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <div class="d-flex flex-column vote-controls">
                            <a href="#" title="This quuestion is useful" class="vote-up">
                                <i class="fas fa-caret-up fa-3x"></i>
                            </a>
                                <span class="votes-count">{{ $question->favorites_count}}</span>
                            <a href="#" title="This question is no useful" class="vote-down off">
